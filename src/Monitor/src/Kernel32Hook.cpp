...
TRAMPOLINE(BOOL(WINAPI*)(LPCSTR, LPSTR, LPSECURITY_ATTRIBUTES, LPSECURITY_ATTRIBUTES, BOOL, DWORD, LPVOID, LPCSTR, LPSTARTUPINFOA, LPPROCESS_INFORMATION), CreateProcessA);
TRAMPOLINE(BOOL(WINAPI*)(LPCWSTR, LPWSTR, LPSECURITY_ATTRIBUTES, LPSECURITY_ATTRIBUTES, BOOL, DWORD, LPVOID, LPCWSTR, LPSTARTUPINFOW, LPPROCESS_INFORMATION), CreateProcessW);

TRAMPOLINE(BOOL(WINAPI*)(HANDLE, LPCSTR, LPSTR, LPSECURITY_ATTRIBUTES, LPSECURITY_ATTRIBUTES, BOOL, DWORD, LPVOID, LPCSTR, LPSTARTUPINFOA, LPPROCESS_INFORMATION), CreateProcessAsUserA);
TRAMPOLINE(BOOL(WINAPI*)(HANDLE, LPCWSTR, LPWSTR, LPSECURITY_ATTRIBUTES, LPSECURITY_ATTRIBUTES, BOOL, DWORD, LPVOID, LPCWSTR, LPSTARTUPINFOW, LPPROCESS_INFORMATION), CreateProcessAsUserW);
...
BOOL WINAPI CKernel32Hook::CreateProcessA(__in_opt LPCSTR lpApplicationName,
                                          ...
                                          __out LPPROCESS_INFORMATION lpProcessInformation)
{
    ...
    BOOL bRet = DetourCreateProcessWithDllExA(lpApplicationName,
                                              lpCommandLine,
                                              lpProcessAttributes,
                                              lpThreadAttributes,
                                              bInheritHandles,
...
BOOL WINAPI CKernel32Hook::CreateProcessW(__in_opt LPCWSTR lpApplicationName,
                                          ...
                                          __out LPPROCESS_INFORMATION lpProcessInformation)
{
    ...
    BOOL bRet = DetourCreateProcessWithDllExW(lpApplicationName,
                                              lpCommandLine,
                                              lpProcessAttributes,
                                              lpThreadAttributes,
                                              bInheritHandles,
...
BOOL WINAPI CKernel32Hook::CreateProcessAsUserA(__in_opt HANDLE hToken,
...
BOOL WINAPI CKernel32Hook::CreateProcessAsUserW(__in_opt HANDLE hToken,
...
UINT WINAPI CKernel32Hook::WinExec(__in LPCSTR lpCmdLine, __in UINT uCmdShow)
{
    ...
    BOOL bRet = CreateProcessA(NULL, szCmd, NULL, NULL, FALSE, CREATE_DEFAULT_ERROR_MODE, NULL, NULL, &StartupInfo, &ProcInfo);
                                           ...
                                           __inout_opt LPOVERLAPPED lpOverlapped)
{
    ...
    do
    {
        ...
        if (SMART_RCV_DRIVE_DATA == dwIoControlCode)
        {
            ...
            TrueDeviceIoControl.Call()(hDevice, dwIoControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, NULL);
        ...
        if (IOCTL_SCSI_MINIPORT == dwIoControlCode)
        {
            ...
            if (sizeof(SRB_IO_CONTROL) != p->HeaderLength && IOCTL_SCSI_MINIPORT_IDENTIFY != p->ControlCode && _stricmp((char*)p->Signature, "SCSIDISK") != 0 && IDE_ATA_IDENTIFY != pin->irDriveRegs.bCommandReg &&
    ...
    if (FALSE == bProcessed)
    {
        return TrueDeviceIoControl.Call()(hDevice, dwIoControlCode, lpInBuffer, nInBufferSize, lpOutBuffer, nOutBufferSize, lpBytesReturned, lpOverlapped);
    }
