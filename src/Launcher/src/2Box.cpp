...
{
    m_strNote += _T("免责声明:\r\n");
    TCHAR msgNote[512] = {_T('本'), _T('软'), _T('件'), _T('完'), _T('全'), _T('免'), _T('费'), ',', _T('仅'), _T('供'), _T('学'), _T('习'), _T('交'), _T('流'), ',',      '\r',     '\n', _T('请'), _T('勿'), _T('用'),
                          _T('于'), _T('任'), _T('何'), _T('商'), _T('业'), _T('用'), _T('途'), ',', '\r',     '\n',     _T('否'), _T('则'), _T('后'), _T('果'), _T('自'), _T('负'), '!',  '\r',     '\n'};

    m_strNote += msgNote;
    m_strNote += _T("\r\n\r\n");

    m_strNote += _T("免费下载地址:\r\n");
    TCHAR msgAddr[512] = {_T('链'), _T('接'), ':', 'h', 't', 't', 'p', 's', ':', '/', '/', 'p', 'a', 'n',  '.',  'b',      'a',      'i', 'd', 'u', '.', 'c',
